            ...
            <div class="col-lg-6">
                <div class="product-single-img">
                    <div class="product-active owl-carousel">
                        <div class="item">
                            <img src="{{asset('uploads/product_photo')}}/{{$products_info->product_thumbnail_photo}}" alt="{{$products_info->product_name}}">
                        </div>
                        <div class="item">
                            <img src="{{asset('ft_asset')}}/images/product/product-details/2.jpg" alt="">
                        </div>
            ...
            <div class="col-lg-3 col-sm-6 col-12">
                <div class="featured-product-wrap">
                    ...
                    <div class="featured-product-content">
                        <div class="row">
                            <div class="col-7">
                            <h3><a href="{{url('product/detiels')}}/{{$value->id}}">{{$value->product_name}}</a></h3>
